...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_showcase_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_showcase_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'title'  => esc_attr__( 'Front Page Header Image', 'toolbar-extras' ),
			'href'   => ddw_tbex_customizer_focus( 'section', 'showcase-image' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
				'title'  => ddw_tbex_string_customize_attr( __( 'Front Page Header Image', 'toolbar-extras' ) )
			)
		)
	);
