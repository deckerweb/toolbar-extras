...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_gallery_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_gallery_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'section', 'bbs_background_image_section' ),
			'meta'   => array(
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'section', 'bbs_front_page_content_settings' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
