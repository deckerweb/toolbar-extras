...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_atmosphere_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_atmosphere_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'section', 'atmosphere-image' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			'id'     => 'atmospherepro-site-identity',
			'parent' => 'theme-creative-customize',
			/* translators: Autofocus section in the Customizer */
