...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_metro_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_metro_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'parent' => 'theme-creative-customize',
			/* translators: Autofocus section in the Customizer */
			'title'  => esc_attr__( 'Backstretch Image', 'toolbar-extras' ),
			'href'   => ddw_tbex_customizer_focus( 'section', 'metro-image' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
				'title'  => ddw_tbex_string_customize_attr( __( 'Backstretch Image', 'toolbar-extras' ) )
			)
		)
	);
