...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_aspire_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_aspire_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'section', 'aspire_journal_section' ),
			'meta'   => array(
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'section', 'aspire-settings' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
