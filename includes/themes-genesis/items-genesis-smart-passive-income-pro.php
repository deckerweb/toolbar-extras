...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_smart_passive_income_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_smart_passive_income_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'title'  => esc_attr__( 'Front Page Background Image', 'toolbar-extras' ),
			'href'   => ddw_tbex_customizer_focus( 'section', 'spi_theme_settings' ),
			'meta'   => array(
				'target' => ddw_tbex_meta_target(),
				'title'  => ddw_tbex_string_customize_attr( __( 'Front Page Background Image', 'toolbar-extras' ) )
			)
		)
	);
