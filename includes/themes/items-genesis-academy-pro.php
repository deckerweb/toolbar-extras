...
// includes/themes/items-genesis-academy-pro
...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_academy_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_academy_pro_customize() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => ddw_tbex_customizer_focus( 'panel', 'academy-settings' ),
			'meta'   => array(
