...
// includes/themes/items-genesis-business-pro
...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_business_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_business_pro_customize() {
