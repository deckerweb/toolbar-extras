...
// includes/themes/items-genesis-foodie-pro
...
add_action( 'admin_bar_menu', 'ddw_tbex_themeitems_foodie_pro_customize', 90 );
/**
 ...
 */
function ddw_tbex_themeitems_foodie_pro_customize() {
 ...
 * @global mixed $GLOBALS[ 'wp_admin_bar' ]
 */
function ddw_tbex_themeitems_foodie_pro() {
	...
	$GLOBALS[ 'wp_admin_bar' ]->add_node(
		array(
			...
			'href'   => esc_url( admin_url( 'admin.php?page=foodie-pro-dashboard' ) ),
			'meta'   => array(
				'target' => '',
				'title'  => esc_attr__( 'Theme Info', 'toolbar-extras' )
			)
