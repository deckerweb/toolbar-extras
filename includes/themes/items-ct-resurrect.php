 ...
 */
function ddw_tbex_themeitems_ct_resurrect( $admin_bar ) {
 ...
 * @param object $admin_bar Object of Toolbar nodes.
 */
function ddw_tbex_themeitems_ct_resurrect_license( $admin_bar ) {
 ...
 * @param object $admin_bar Object of Toolbar nodes.
 */
function ddw_tbex_themeitems_ct_resurrect_customize( $admin_bar ) {
